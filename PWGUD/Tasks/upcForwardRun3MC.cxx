...
struct UPCForwardRun3MC {
  ...
  void process(aod::Collision const& collision, soa::Filtered<aod::FwdTracks> const& tracksMuon, soa::Join<aod::BCs, aod::Run2BCInfos, aod::BcSels> const& bcs)
  //void process(soa::Join<aod::BCs, aod::Run2BCInfos, aod::BcSels>::iterator const& bc, soa::Filtered<aod::FwdTracks> const& tracksMuon)
  {
    auto bc = collision.bc_as<soa::Join<aod::BCs, aod::Run2BCInfos, aod::BcSels>>();
